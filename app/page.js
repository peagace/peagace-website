      ...
      >
          <h1 className='text-xs text-gray uppercase'>em desenvolvimento * 開発中で * в разработке</h1>
            ...
            <motion.div className='flex flex-col'>
              ...
              className='text-half xxl:text-xl xl:text-xl lg:text-xl md:text-xl sm:mtext-xl text-right text-black'>UNDER <span className='font-[1]'>DEV</span>.</motion.p>       

              <motion.p 
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
              transition={{ duration: 0.4, delay:1, easings:['easeOut'] }} 
               className='text-right text-base mt-4 text-gray font-thin'><a href="https://www.hokup.com.br/" target={"_blank"} rel={"noreferrer"} className='text-base text-black underline cursor:pointer hover:ease-out hover:transition hover:duration-100 ease-out transition duration-100 hover:text-accent'>pedro@peagace.com</a></motion.p >
              <motion.p  
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
              transition={{ duration: 0.4, delay:1.2, easings:['easeOut'] }} 
              
              className='text-base text-gray text-right mt-2'>São Paulo, Brasil<br></br>
              19:06 GMT-3<br></br></motion.p >  
