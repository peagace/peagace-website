  ...
  return (
    <>
      ...
      <section className='bg-lightgray relative h-screen w-full flex'>
        ...
        <div className='flex flex-col self-end w-full h-svh'>
      ...
      <section className='bg-lightgray grid grid-cols-12 pt-[60px] px-4' id="about">
        ...
        <div className='lg:col-span-6 lg:col-start-6 col-span-12 pt-[60px] lg:pt-0'>
          ...
          <p className='text-base pt-[10px] text-black pb-[40px]'>Designer with over 8+ years of experience helping worldwide brands to create unique digital projects from scratch blending Art Direction, Animation, 3D, Illustration, Branding, UI and Code seamlessly.
