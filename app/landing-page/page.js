    ...
    <>
      ...
      <section className='bg-lightgray grid grid-cols-12'>
        <div className='col-span-12 xxl:col-span-4 xl:col-span-4 lg:col-span-6 md:col-span-6 mx-4 mt-24'>
          ...
          <p className='text-xs mt-4 text-gray'>CONCEPT DESIGN / 3D / SIMULATION</p>
          <p className='text-base mt-2 text-black font-thin'>NIKE AIR PILLS</p>          
        </div>

        <div className='col-span-12 xxl:col-span-4 xl:col-span-4 lg:col-span-6 md:col-span-6  mx-4 mt-24'>
          <div className='bg-gray h-[600px]'></div>
          <p className='text-xs mt-4 text-gray'>CONCEPT DESIGN / 3D / ANIMATION</p>
          <p className='text-base mt-2 text-black font-thin'>SÓ MAIS UMA</p>          
        </div> 

        <div className='col-span-12 xxl:col-span-4 xl:col-span-4 lg:col-span-6 md:col-span-6  mx-4 mt-24'>
          <div className='bg-gray h-[600px]'></div>
          <p className='text-xs mt-4 text-gray'>PRODUCT DESIGN / 3D</p>
          <p className='text-base mt-2 text-black font-thin'>NFTOYER</p>          
        </div>
